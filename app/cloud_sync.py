...
def _payload_vistoria(row: dict, fotos: list | None = None) -> dict:
    ...
    return {
        ...
        "resultado_especie": row.get("resultado_especie"),
        "especie_status": row.get("especie_status"),
        "especie_catalogo_id": row.get("especie_catalogo_id"),
        "foto_especie": row.get("foto_especie"),
        "observacoes": row.get("observacoes"),
